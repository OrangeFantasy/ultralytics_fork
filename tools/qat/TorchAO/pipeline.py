...
class TorchAO_Pipeline(QAT_Pipeline):
    @staticmethod
    def convert_fx(model: fx.GraphModule) -> fx.GraphModule:
    ...
    def prepare(
        ...
        **ignore_kwargs
        ...
        if qat_weights:
            model_qat = self.convert_fx(model_qat)
