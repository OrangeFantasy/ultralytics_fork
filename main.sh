...
#     --model runs/multi-head/train/20260127_154721_yolov8s_25kpts_2H/weights/best.pt \
#     --data cfg/ball_sports/datasets/25kpts_2H_Solid.yaml --mode train --nkpts 25 \
#     --device 0,3 --epochs 300 --batch 256 --imgsz 448 768 --act relu6 \
#     --override_hyp "{ 'scale': 0.6, 'albumentations': 1.0, 'close_mosaic': 20, 'box': 10.0, 'dfl': 2.0, 'cls': 1.0 ,'kobj': 0.25, 'rle': 0.5 }" \
...
python main.py \
    ...
    --override_hyp "{ 'scale': 0.6, 'albumentations': 1.0, 'close_mosaic': 90, 'box': 10.0, 'dfl': 2.0, 'cls': 1.0 ,'kobj': 0.25, 'rle': 0.5 }" \
    --workers 8 --logging tensorboard # 0310
...
python main.py \
    ...
    --data cfg/qrcode/datasets/19kpts_MergeRaiseHandAndStandUp.yaml --mode train --nkpts 19 --class_ranges "[[0, 0], [1, 5], [2, 5], [6, 6], [7, 10], [11, 11]]" \
...
python main.py \
    ...
    --pretrained runs/multi-head/qrcode/20260310_205410_yolov8s_19kpts_MergeRaiseHandAndStandUp/weights/best.fp16.state_dict.pt \
    --data cfg/classroom/datasets/19kpts_Student_MergeActions.yaml --mode train --nkpts 19 --class_ranges "[[0, 0], [1, 5], [2, 5], [6, 6]]" \
    --device 3 --epochs 100 --batch 256 --imgsz 448 768 --act relu6 \
    --override_hyp "{ 'scale': 0.6, 'albumentations': 0.0, 'mosaic': 0.0, 'box': 10.0, 'dfl': 2.0, 'rle': 0.75 }" \
    --workers 8 --logging tensorboard --project classroom
...
python main_qat.py \
    ...
    --device 2 --epoch 10 --batch 128 --imgsz 448 768 --act relu6 \
    --override_hyp "{ 'scale': 0.6, 'fliplr': 0.0, 'albumentations': 0.0, 'mosaic': 0.0, 'box': 10.0, 'dfl': 2.0, 'rle': 0.75 }" \
    --workers 0 --logging tensorboard --project classroom_qat
